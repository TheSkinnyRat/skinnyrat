          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="p-5">
                ...
                <form class="user" id="login_form" method="post" action="<?php if($url_continue != NULL) echo base_url('member/do_login?cn='.urlencode($url_continue)); else echo base_url('member/do_login'); ?>">
