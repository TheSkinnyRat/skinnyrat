<!-- Begin Page Content -->
  ...
  <div class="row">
          ...
          <?php if ($data->private == '0') { ?>
            ...
            <div class="card">
              ...
              <form id="article_rand_form" class="text-center p-2" action="<?php echo base_url('api/show_more') ?>" method="get">
                ...
                <input type="hidden" name="last" value="3">
    ...
    <div class="col-lg-4 pl-lg-0">
      <?php if ($data->private == '0') { ?>
        <div class="card my-1">
          <a href="#panel1" class="card-header py-3" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="panel1">
            <h6 class="m-0 font-weight-bold text-primary"><i class="far fa-newspaper"></i> Other Article</h6>
          </a>
          <div class="collapse show" id="panel1">
            <div class="card-body p-0">
              <div class="">
                <div id="article_rand_1">
                  <?php foreach ($article_rand as $a_new) { ?>
                    <a href="<?php echo base_url('b/'.$a_new->name) ?>" class="text-secondary  mb-1 ">
                      <div class="row p-1 m-1 align-items-center">
                        <div class="col-auto pr-0" style="min-height: 72px">
                ...
                <form id="article_rand_1_form" class="text-center p-2" action="<?php echo base_url('api/show_more') ?>" method="get">
                  <input type="hidden" name="type" value="article_rand">
                  <input type="hidden" name="random_id" value="<?php echo $random_id ?>">
                  <input type="hidden" name="last" value="3">
                  <input type="hidden" name="limit" value="3">
                  <button class="btn btn-white btn-sm w-100 h-100" type="submit" onclick="show_more('article_rand_1')"><i class="fa fa-angle-down"></i> Lainnya</button>
                </form>
              </div>
            </div>
          </div>
        ...
        <div class="card my-1">
          <a href="#panel2" class="card-header py-3" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="panel2">
            <h6 class="m-0 font-weight-bold text-primary"><i class="fa fa-plus-square"></i> Latest Article</h6>
          </a>
          <div class="collapse show" id="panel2">
            <div class="card-body p-0">
              <div class="">
                <div id="article_new">
