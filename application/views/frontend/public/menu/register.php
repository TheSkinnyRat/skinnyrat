          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="p-5">
                ...
                <form class="user" id="register_form" method="post" action="<?php if($ref != NULL) echo base_url('member/register_add?ref='.urlencode($ref)); else echo base_url('member/register_add') ?>">
                  ...
                  <input type="hidden" name="id_member" value="0">
                  <!--				-------------------------------------------------------------------------------------------------------->
...
<script src="<?php echo base_url('assets/frontend/js/page/register.js') ?>"></script>
