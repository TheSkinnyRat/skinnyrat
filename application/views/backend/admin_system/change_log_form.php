<div class="row">
	<div class="col-lg-12">
		<h1 class="page-header">Form Data Change Log</h1>
	</div>
	<!-- /.col-lg-12 -->
</div>
...
<div class="panel panel-default">
	<div class="panel-heading">
		<h3 class="panel-title">Form Data Change Log</h3>
	</div>
	<form class="form-horizontal" method="POST" id="change_log_form" action="<?php if($data!=null) echo base_url('admin_system/change_log_update'); else echo base_url('admin_system/change_log_add'); ?>">
...
<script src="<?php echo base_url('assets/backend/js/page/change_log_form.js') ?>"></script>
