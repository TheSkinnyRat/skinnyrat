    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <div class="text-right">
          <div class="pull-left panel-title">Data Member</div>
          <a class="btn btn-success btn-add" href="<?php echo base_url('admin_system/member_form') ?>"><i class="fa fa-plus"></i> Tambah Data</a>
        </div>
      </div>
      <!-- /.panel-heading -->
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="text-center">
                <form action="<?php echo base_url('admin_system/member_form') ?>" method="post">
                  <input type="hidden" name="id" value="<?php echo $d1->id_member ?>">
              ...
              <td class="text-center">
                <form action="<?php echo base_url('admin_system/member_delete') ?>" method="post">
                  <input type="hidden" name="id" value="<?php echo $d1->id_member ?>">
...
<script src="<?php echo base_url('assets/backend/js/page/member.js') ?>"></script>
