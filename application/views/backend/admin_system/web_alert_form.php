<div class="row">
	<div class="col-lg-12">
		<h1 class="page-header">Form Web Alert</h1>
	</div>
	<!-- /.col-lg-12 -->
</div>
...
<div class="panel panel-default">
	<div class="panel-heading">
		<h3 class="panel-title">Form Web Alert</h3>
	</div>
	<form class="form-horizontal" method="POST" id="admin_form" action="<?php if($data!=null) echo base_url('admin_system/web_alert_update'); else echo base_url('admin_system/web_alert_add'); ?>">
